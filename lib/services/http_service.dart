...
class Network {
  ...
  static String API_LIST = "/banking/posts";
  static String API_CREATE = "/banking/posts";
  static String API_UPDATE = "/banking/posts/"; //{id}
  static String API_DELETE = "/banking/posts/"; //{id}
  ...
  static List<Post> parsePostList(String body){
    List<Post> posts = List.from(jsonDecode(body)).map((e) => Post.fromJson(e)).toList();
    return posts;
  }
}